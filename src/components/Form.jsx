    ...
    <div className="container mt-5">
      <form>
        <div className="mb-3">
          ...
          <input type="text" className="form-control" id="fname" name="fname" defaultValue="John" />
        </div>
        <div className="mb-3">
          <label htmlFor="lname" className="form-label text-white">Last name:</label>
          <input type="text" className="form-control" id="lname" name="lname" defaultValue="Doe" />
        </div>
        <div className="mb-3">
        ...
        <div className="mb-3">
          ...
          <div className="d-flex align-items-center">
            <input type="radio" className="form-check-input me-1" id="male" name="sex" value="male" />
            <label htmlFor="male" className="form-check-label text-white">Male</label>
          </div>
          <div className="d-flex align-items-center">
            <input type="radio" className="form-check-input me-1" id="female" name="sex" value="female" />
            <label htmlFor="female" className="form-check-label text-white">Female</label>
          </div>
          <div className="d-flex align-items-center">
            <input type="radio" className="form-check-input me-1" id="non-binary" name="sex" value="non-binary" />
            <label htmlFor="non-binary" className="form-check-label text-white">Non-binary</label>
          </div>
        </div>
