export const questions = [
    ...
    { id: "healthConditions", question: "What are your current health conditions?", type: "text" },
    { id: "healthHistory", question: "Please enter your family health history.", type: "text" },
    { id: "mealsPerDay", question: "How many meals do you eat per day?", type: "select", options: ["0-1", "1-3", "4+", "Prefer small snacks throughout the day", "Prefer not to say"] },
    { id: "healthGoals", question: "What are your current health goals (ex: Lose 10 pounds, increase stamina, etc.)?", type: "text" },
  ];